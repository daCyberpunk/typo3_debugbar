...
if (TYPO3_MODE === 'FE') {
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php']['connectToDB'][] =
        'Konafets\\Typo3Debugbar\\Typo3DebugBarServiceProvider->injectDbalLoggerToDbConnection';

    //$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/index_ts.php']['postBeUser'][] =
    //    'Konafets\\Typo3Debugbar\\Typo3DebugBarServiceProvider->register';

    //$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/index_ts.php']['postBeUser'][] =
    //    'Konafets\\Typo3Debugbar\\Typo3DebugBarServiceProvider->boot';

    //$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_pagerenderer.php']['render-preProcess'][] =
    //    'Konafets\\Typo3Debugbar\\Typo3DebugBarServiceProvider->addAssets';

    //$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php']['hook_eofe'][] =
    //    'Konafets\\Typo3Debugbar\\Typo3DebugBarServiceProvider->addDebugBar';
}
